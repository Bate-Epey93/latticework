...
(function(){
  ...
  const JOBS = {
    ...
    copy: { label:"Marketing copy (PAS / BAB)", slots:[
      {key:"reader", zone:"A", heading:"Who you're talking to, and the pain they feel now", move:"Enter the conversation already in their head", models:["aud","loss"],
       prompt:"One reader. What are they feeling right now, in their words — the frustration or fear that brought them here?"},
      {key:"problem", zone:"space", heading:"Problem — name it in their words", move:"State the pain plainly (the P in PAS)", models:["loss"],
       prompt:"Name the problem exactly as they'd say it. No jargon, no brand-speak — the sentence they think at 2am."},
      {key:"agitate", zone:"space", heading:"Agitate — make the cost vivid and present", move:"Show what it's costing them to stay put", models:["loss","diss"],
       prompt:"Make the ongoing cost real — money, time, worry, the future they're risking. Don't overreach; true and specific."},
      {key:"turn", zone:"space", heading:"The turn — plain-words bridge to the answer", move:"Pivot from pain to solution, jargon-free", models:["pyr","cok"],
       prompt:"The 'here's the way out' line. Lead with the payoff, in words a 12-year-old gets."},
      {key:"proof", zone:"space", heading:"Proof — evidence + handle the doubt", move:"Back the claim; answer the strongest objection", models:["proof","signal","steel"],
       prompt:"The proof that makes it believable (result, testimonial, guarantee), and the one objection you must disarm."},
      {key:"after", zone:"space", heading:"After — paint the better state", move:"The 'after' half of before-after-bridge", models:["jtbd"],
       prompt:"Show the reader's life once the job is done — concrete, sensory, the progress they actually wanted."},
      {key:"cta", zone:"B", heading:"The one ask", move:"A single, unmistakable action", models:["pos","aud"],
       prompt:"One action, stated once. Exact copy for the button or line. What do they do next?"},
    ]},
    strategy: { label:"Content strategy", slots:[
      {key:"audience", zone:"A", heading:"Audience + the job they hire content for", move:"Define who, and the progress they seek", models:["aud","jtbd"],
       prompt:"Who is this for, and what job are they hiring your content to do (learn, decide, trust, buy)?"},
      {key:"present", zone:"A", heading:"Present state — where they are now", move:"Map their stage and what already exists", models:["base","funnel"],
       prompt:"Where are they in the funnel? What do they already know/read, and what does the current content landscape look like?"},
      {key:"gap", zone:"space", heading:"The gap — broken into themes", move:"Turn the missing middle into pillars/clusters", models:["cok","decomp"],
       prompt:"What's missing or unclear between where they are and where you want them? Break it into 3–5 content pillars or clusters."},
      {key:"authority", zone:"space", heading:"Authority plan — how you earn trust", move:"Signal expertise the category can't fake", models:["signal","proof"],
       prompt:"How does this content earn trust — original data, expert POV, EEAT, proof? What makes you the source, not a rewriter?"},
      {key:"sequence", zone:"space", heading:"Sequencing — the path and its knock-ons", move:"Order the pieces; watch second-order effects", models:["funnel","so"],
       prompt:"What order do the pieces go in (hub, spokes, flywheel)? What does each unlock, and what downstream effects to watch?"},
      {key:"position", zone:"B", heading:"Positioning — the one slot you own", move:"The single idea this body of work claims", models:["pos"],
       prompt:"After all this content, what one slot do you own in the reader's mind? State it in a sentence."},
